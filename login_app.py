...
p = Entry(login,width=20,bg="white", fg="black")
...
if logged == True:
    ...
    # entry
    item = Entry(window, width=20, bg="purple", fg="white")
    item.grid(row=5, column=20,sticky=W)

    price = Entry(window, width=20, bg="purple", fg="white")
    price.grid(row=7, column=20,sticky=W)

    quantity = Entry(window, width=20, bg="purple", fg="white")
    quantity.grid(row=9, column=20,sticky=W)

    bill = scrolledtext.ScrolledText(window, width=50,height=5, wrap=WORD, bg="#96a19d", fg="black")
